            ...
            <div class="box">
                <form method="POST" action="feed.php">
                    ...
                    <div class="post-input-container">
                        <div class="post-avatar" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--accent-red) 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; width: 50px; height: 50px; border-radius: 50%;">
                ...
                <?php foreach ($tousLesPosts as $p): ?>
                    <div class="box post-card" id="post-<?= $p['id'] ?>" style="<?= ($p['is_pinned'] ?? false) ? 'border-left: 4px solid #ffc107;' : '' ?>">
                        <div class="post-header" style="display: flex; gap: 15px; margin-bottom: 15px;">
                            <div class="post-avatar" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); width: 45px; height: 45px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;">
                        ...
                        <div class="post-footer" style="display: flex; gap: 20px; border-top: 1px solid var(--border-color); padding-top: 10px;">
                            ...
                            <button class="action-btn comment-toggle">💬 <?= method_exists($post, 'getCommentaireCount') ? $post->getCommentaireCount($p['id']) : '0' ?></button>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
